...
| Vehicle Number | Input Owner Name | Owner Name |
| --- | --- | --- |
| MH01AB1234 | SUJAN MISTRI | S***N M****I |
| MH02CD5678 | MADHU MISHRA | K*C B******N P*T L*D |
| MH03EF9012 | PRATIK DNYANDEV JADHAV | D******V J****V |

The app also supports the older two-column format: `Original Name` and `Masked Name`.
If exact column names are missing, three-column files use the second and third columns as owner names.
